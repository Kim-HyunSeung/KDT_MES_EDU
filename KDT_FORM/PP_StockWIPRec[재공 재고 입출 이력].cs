...
namespace KDT_Form
{
    public partial class PP_StockWIPRec : DC00_WinForm.BaseMDIChildForm
    {
        ...
        #region < FORM EVENTS >
        private void PP_StockWIPRec_Load(object sender, EventArgs e)
        { 
        ...
        private void DoFind()
        {
            ...
            { 
                ...
                rtnDtTemp = helper.FillTable("PP_STockWIPRec_S1", CommandType.StoredProcedure
