...
namespace KDT_Form
{
    public partial class WM_ProdInStock : DC00_WinForm.BaseMDIChildForm
    {
        ...
        {
            InitializeComponent();
            //this.plantCode = appConfig.AppSettings.Settings["Site"].Value.ToString();
        ...
        private void WM_ProdInStock_Load(object sender, EventArgs e)
        {
            ...
            //grid1.DisplayLayout.Bands[0].Columns["ITEMTYPE"].Header.Appearance.ForeColor  = Color.Blue;
            //grid1.DisplayLayout.Bands[0].Columns["ITEMCODE"].Header.Appearance.ForeColor  = Color.Blue;
            //grid1.DisplayLayout.Bands[0].Columns["ITEMNAME"].Header.Appearance.ForeColor  = Color.Blue;
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                rtnDtTemp = helper.FillTable("WM_ProdInStock_S1", CommandType.StoredProcedure
