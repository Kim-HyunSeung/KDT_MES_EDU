            ...
            try
            {
                ...
                try
                {
                    Helper.ExecuteNoneQuery("SPROC_SystemHandleImfo", CommandType.StoredProcedure
                                                    , Helper.CreateParameter("PROGRAMID", "MAIN")
                                                    , Helper.CreateParameter("WORKERID", userid)
                                                    , Helper.CreateParameter("WORKTYPE", sType)
                                                    , Helper.CreateParameter("IP", IP)
                                                    , Helper.CreateParameter("COMNAME", System.Environment.MachineName.ToString()));
